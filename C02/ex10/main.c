...
/*   Updated: 2019/06/12 19:39:34 by badam            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n%s\n",
			...
			dest4a[1] == 0 ? "Pass" : "Fail -- Should fill with \\0");
}
